  ...
  en: {
    translation: {
      ...
      leaderboard: {
        ...
        trending: 'Trending',
        hot: 'Hot',
        searchPlaceholder: 'Search skills.sh leaderboard...',
        rank: 'Rank',
        skill: 'Skill',
        installs: 'Installs',
        install: 'Install',
      ...
      toolSkills: {
        ...
        selectedSummary: '{{tool}} has {{count}} skills',
  ...
  zh: {
    translation: {
      ...
      leaderboard: {
        ...
        queueEmpty: '还没有下载任务',
        queueSummary:
          '排队 {{queued}} · 进行中 {{running}} · 完成 {{completed}} · 失败 {{failed}}',
        empty: '暂无榜单数据',
        loadFailed: '加载榜单失败',
      ...
      toolSkills: {
        ...
        installed: '已安装',
        notInstalled: '未安装',
        selectedSummary: '{{tool}} 下共有 {{count}} 个 Skills',
        emptyTools: '暂无可用工具信息。',
        emptyForTool: '{{tool}} 下还没有同步的 Skills。',
      },
      navSkills: '我的 Skills',
      loading: '加载中...',
      sharedDirConfirm:
